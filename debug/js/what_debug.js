...
function survey(){
  ...
  loadJSON('exp_input.json', function(data){
    ...
    temp += "<div class=\"wrap\"><form id=\"formy\" onsubmit=\" event.preventDefault(); submitting();\" >";
    for (var i=0; i<Object.keys(survey).length; i++) {
    ...
    temp += "<div class=\"buttons\"><button class=\"clear\">Clear</button><button \"submit\" class=\"submit\">Submit</button></div>";
    temp += "</form></div>";
